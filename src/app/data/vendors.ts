...
const _manualVendors: Vendor[] = [
  ...
  },
  {
    ...
    globalPointOfContacts: [
      ...
      { initials: "HT", name: "Helen Taylor", bgColor: "hsl(var(--success))" },
      { initials: "IB", name: "Ivan Brown", bgColor: "hsl(var(--warning))" },
    ],
    partnerGroup: "PG-1-1",
  ...
  },
  {
    ...
    globalPointOfContacts: [
      ...
      { initials: "IP", name: "Iris Park", bgColor: "hsl(var(--success))" },
      { initials: "JT", name: "Jack Taylor", bgColor: "hsl(var(--warning))" },
      { initials: "KR", name: "Karen Roberts", bgColor: "hsl(var(--violet))" },
      ...
      { initials: "RC", name: "Rachel Clark", bgColor: "hsl(var(--destructive))" },
  ...
  },
  {
    ...
    globalPointOfContacts: [
      ...
      { initials: "NS", name: "Nancy Scott", bgColor: "hsl(var(--success))" },
      { initials: "OL", name: "Oscar Lee", bgColor: "hsl(var(--warning))" },
      { initials: "PR", name: "Pat Robinson", bgColor: "hsl(var(--violet))" },
    ],
    partnerGroup: "PG-1-1",
  ...
  },
  {
    ...
    globalPointOfContacts: [
      ...
      { initials: "IR", name: "Iris Robinson", bgColor: "hsl(var(--success))" },
      { initials: "JB", name: "Jack Brown", bgColor: "hsl(var(--warning))" },
      { initials: "KF", name: "Karen Fisher", bgColor: "hsl(var(--violet))" },
  ...
  },
  {
    ...
    globalPointOfContacts: [
      ...
      { initials: "MN", name: "Mia Nguyen", bgColor: "hsl(var(--success))" },
      { initials: "OP", name: "Oscar Park", bgColor: "hsl(var(--warning))" },
      { initials: "QR", name: "Quinn Roberts", bgColor: "hsl(var(--violet))" },
    ],
    partnerGroup: "PG-1-1",
  ...
  },
  {
    ...
    globalPointOfContacts: [
      ...
      { initials: "MN", name: "Maria Nguyen", bgColor: "hsl(var(--success))" },
      { initials: "OP", name: "Oscar Park", bgColor: "hsl(var(--warning))" },
      { initials: "QR", name: "Quinn Roberts", bgColor: "hsl(var(--violet))" },
      ...
      { initials: "EF", name: "Elena Fisher", bgColor: "hsl(var(--destructive))" },
...
const BG_COLORS = ["#0ea5e9", "#8b5cf6", "#f59e0b", "#10b981", "#ef4444", "#6366f1", "#ec4899", "#14b8a6", "#f97316", "#84cc16", "#a855f7", "#0891b2", "#e11d48", "#4f46e5", "hsl(var(--success))", "hsl(var(--warning))"];
