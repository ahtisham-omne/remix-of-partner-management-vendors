...
export const PAYMENT_TERM_PRESETS: PaymentTermPreset[] = [
  ...
  { id: "pt-12", name: "2/10 Net 30", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "2% discount if paid in 10 days, otherwise net 30.", vendorsApplied: 7 },
];
