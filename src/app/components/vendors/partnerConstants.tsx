...
export const PAYMENT_TERM_PRESETS: PaymentTermPreset[] = [
  { id: "pt-1", name: "Net 10", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "Payment is due 10 days after the invoice date.", vendorsApplied: 4 },
  { id: "pt-2", name: "Net 15", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "Payment is due 15 days after the invoice date.", vendorsApplied: 6 },
  { id: "pt-3", name: "Net 20", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "Payment is due 20 days after the invoice date.", vendorsApplied: 3 },
  { id: "pt-4", name: "Net 30 Post Shipping", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Shipping", description: "Full payment is due 30 days after the goods are shipped.", vendorsApplied: 5 },
  { id: "pt-5", name: "Net 45 Post Delivery", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Delivery", description: "Payment is due 45 days after goods are delivered.", vendorsApplied: 2 },
  { id: "pt-6", name: "Net 60 Post Production End", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Production End", description: "Payment is due 60 days after production is completed.", vendorsApplied: 3 },
  ...
  { id: "pt-12", name: "2/10 Net 30", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "2% discount if paid in 10 days, otherwise net 30.", vendorsApplied: 7, applyDiscount: true, discountPercent: "2", discountPeriod: "10" },
