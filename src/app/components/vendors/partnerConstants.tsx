...
export const PARTNER_LOCATION_ITEMS: PartnerLocationItem[] = [
  { id: "pl-1", name: "FR Conversions, Westminster", type: "location", logoColor: "#6B5CE7", logoText: "FR", location: "Westminster, CO 80234" },
  { id: "pl-2", name: "Toyota Location 206", type: "location", logoColor: "#374151", logoText: "T", location: "Georgetown, KY 40324" },
  { id: "pl-3", name: "Toyota International", type: "partner", logoColor: "#374151", logoText: "T", location: "Plano, TX 75024" },
  { id: "pl-4", name: "Ford Motor Company USA", type: "partner", logoColor: "#1E40AF", logoText: "F", location: "Dearborn, MI 48126" },
  { id: "pl-5", name: "General Motors (GM)", type: "partner", logoColor: "#1D4ED8", logoText: "GM", location: "Detroit, MI 48265" },
  { id: "pl-6", name: "Tesla, Inc.", type: "partner", logoColor: "#DC2626", logoText: "T", location: "Austin, TX 78725" },
  { id: "pl-7", name: "FR Conversions", type: "partner", logoColor: "#6B5CE7", logoText: "FR", isDefault: true, location: "Westminster, CO 80234" },
  { id: "pl-8", name: "Chrysler (Stellantis N.V.)", type: "partner", logoColor: "#1E3A5F", logoText: "C", location: "Auburn Hills, MI 48326" },
  { id: "pl-9", name: "Rivian Automotive", type: "partner", logoColor: "#0A6B3D", logoText: "R", location: "Irvine, CA 92618" },
];
...
export const PAYMENT_TERM_PRESETS: PaymentTermPreset[] = [
  { id: "pt-1", name: "Net 10", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "Payment is due 10 days after the invoice date.", vendorsApplied: 4, duration: "10", applyDiscount: true, discountPercent: "2", discountPeriod: "5" },
  { id: "pt-2", name: "Net 15", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "Payment is due 15 days after the invoice date.", vendorsApplied: 6, duration: "15", applyDiscount: true, discountPercent: "1.5", discountPeriod: "7" },
  { id: "pt-3", name: "Net 20", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Invoice Date", description: "Payment is due 20 days after the invoice date.", vendorsApplied: 3, duration: "20", applyDiscount: true, discountPercent: "2", discountPeriod: "10" },
  { id: "pt-4", name: "Net 30 Post Shipping", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Shipping", description: "Full payment is due 30 days after the goods are shipped.", vendorsApplied: 5, duration: "30", applyDiscount: true, discountPercent: "2", discountPeriod: "10" },
  { id: "pt-5", name: "Net 45 Post Delivery", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Delivery", description: "Payment is due 45 days after goods are delivered.", vendorsApplied: 2, duration: "45", applyDiscount: true, discountPercent: "1", discountPeriod: "15" },
  { id: "pt-6", name: "Net 60 Post Production End", category: "net", typeBadge: "NET", badgeColor: "#0A77FF", trigger: "Production End", description: "Payment is due 60 days after production is completed.", vendorsApplied: 3, duration: "60", applyDiscount: true, discountPercent: "2", discountPeriod: "10" },
